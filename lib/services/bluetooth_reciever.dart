import 'package:visionlink/models/g1/glass.dart';
import 'package:visionlink/models/g1/commands.dart';
import 'package:visionlink/models/g1/voice_note.dart';
import 'package:visionlink/models/voice/voice_commands.dart';
import 'package:visionlink/services/bluetooth_manager.dart';
import 'package:visionlink/services/whisper.dart';
import 'package:visionlink/utils/lc3.dart';
...
class BluetoothReciever {
  ...
  static final _transcriptionController = StreamController<String>.broadcast();
  ...
  void handleEvenAICommand(GlassSide side, int subcmd) async {
    ...
    switch (subcmd) {
      ...
      case 24:
        ...
        await bt.sendText("");
        await supabase.insertTranscription(transcription);
        break;
