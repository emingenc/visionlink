import 'package:visionlink/models/visionlink/whispermodel.dart';
...
class WhisperSettingsPageState extends State<WhisperSettingsPage> {
  final List<String> _models = VisionlinkWhisperModel.models;
  ...
  Future<void> _downloadModel() async {
    ...
    final Whisper whisper = Whisper(
        model: VisionlinkWhisperModel(_selectedModel!).model,
        downloadHost:
