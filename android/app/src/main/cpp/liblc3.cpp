...
Java_dev_visionlink_coreos_cpp_Cpp_decodeLC3(JNIEnv *env, jclass instance, jbyteArray lc3Data) {
...
Java_dev_visionlink_coreos_cpp_Cpp_rnNoise(JNIEnv *env, jclass clazz,jlong st, jfloatArray input) {
...
Java_dev_visionlink_coreos_cpp_Cpp_createRNNoiseState(JNIEnv *env, jclass clazz) {
    return (jlong) rnnoise_create(NULL);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_visionlink_coreos_cpp_Cpp_destroyRNNoiseState(JNIEnv *env, jclass clazz, jlong st) {
